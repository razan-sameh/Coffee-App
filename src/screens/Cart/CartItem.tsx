...
import { getProductById, decreaseCountItemInCart, addItemInCart, removeItemFromCart } from "../../Content/Database";
            ...
            <View style={Styles.cartItemContainer}>
                ...
                <View style={Styles.itemCountContainer}>
                    <View style={Styles.itemCountSubContainer}>
                        <TouchableWithoutFeedback onPress={() => { decreaseCountItemInCart(item.Uid, tpvProduct.ID,item.size) }}>
                    ...
                    <TouchableWithoutFeedback onPress={() => { removeItemFromCart(item.Uid, tpvProduct.ID,item.size) }}>
