                ...
                pages={[
                    {
                        ...
                        image: <FastImage style={Styles.image} source={images.Onboarding1} />,
                        title: 'Title',
                        subtitle: 'Done with React Native Onboarding Swiper',
                    },
                    {
                        backgroundColor: strSecondColor,
                        image: <FastImage style={Styles.image} source={images.Onboarding2} />,
                        title: 'Title',
                        subtitle: 'Done with React Native Onboarding Swiper',
                    },
                    {
                        backgroundColor: strSecondColor,
                        image: <FastImage style={Styles.image} source={images.Onboarding3} />,
                        title: 'Title',
                        subtitle: 'Done with React Native Onboarding Swiper',
                    },
                ]}
